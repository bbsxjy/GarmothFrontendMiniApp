...
class Router {
  ...
  static get instance() {
    ...
    if (!this._instance) {
      this._instance = new Router(singletonEnforcer)
    }
...
const authRoutes = ['pages/home/index', 'pages/profile/index', 'pages/news/index']
// 全部路由
const routes = ['pages/blank/index', 'pages/index/index', 'pages/home/index', 'pages/profile/index', 'pages/news/index']
